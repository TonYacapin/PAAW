    ...
    Papa.parse(file, {
      ...
      complete: (result) => {
        ...
        setRegulatoryService({
          ...
          otherServices: data.otherServices ? data.otherServices.split(',').filter(Boolean) : [''],
        });
      },
    });
  };
      ...
      case 1:
        return (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block mb-2 font-medium">Animals to be Shipped</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block mb-2 font-medium">Name of Owner/Farm</label>
                <input
                  type="text"
                  name="ownerFarmName"
              ...
              <div>
                <label className="block mb-2 font-medium">Name of Registered Transport Carrier</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block mb-2 font-medium">Vehicle Plate Number</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block mb-2 font-medium">Date of Pick-up/Loading</label>
                <input
                  type="date"
                  name="loadingDate"
