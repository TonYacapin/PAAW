...
import OffspringMonitoringList from "../OffspringMonitoringList";
import TechnicianQuarterlyReportFormList from "../TechnicianQuarterlyReportFormList";
  ...
  const renderModalContent = () => {
    switch (modalContent) {
      ...
      case "OffspringMonitoringList":
        return < OffspringMonitoringList />;
      case "TechnicianQuarterlyReportFormList":
        return < TechnicianQuarterlyReportFormList />;
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <button
                    onClick={() => openModalWithContent("TechnicianQuarterlyReportFormList")}
                    className={buttonClasses}
                  >
