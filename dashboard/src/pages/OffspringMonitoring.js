...
const OffspringMonitoring = () => {
  ...
  const exportAsCSV = () => {
    ...
    const fileName = `offspring_monitoring_report_${municipality}_${dateReported}.csv`;
          ...
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
            <div className="bg-white p-8 rounded shadow-lg w-full max-w-3xl max-h-screen overflow-y-auto">
              <h3 className="text-2xl font-bold mb-4">
                Edit Offspring Monitoring Entry {entries[selectedEntry].no}
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <input
                    id="firstName"
                    type="text"
                    value={entries[selectedEntry].firstName}
                    onChange={(e) =>
                      handleEntryChange(
                        selectedEntry,
                        "firstName",
                ...
                <div>
                  ...
                  <input
                    id="lastName"
                    type="text"
                    value={entries[selectedEntry].lastName}
                    onChange={(e) =>
                      handleEntryChange(
                        selectedEntry,
                        "lastName",
                ...
                <div>
                  <label htmlFor="dateOfAi" className="block mb-1">
                    Date of AI
                  </label>
                  <input
                    id="dateOfAi"
                ...
                <div>
                  <label htmlFor="dateOfMonitoring" className="block mb-1">
                    Date of Monitoring
                  </label>
                  <input
                    id="dateOfMonitoring"
                ...
                <div>
                  <label htmlFor="aiTech" className="block mb-1">
                    AI Tech
                  </label>
                  <input
                    id="aiTech"
                    ...
                    onChange={(e) =>
                      handleEntryChange(selectedEntry, "aiTech", e.target.value)
                    }
                    className="border p-2 rounded w-full"
                  />
                </div>
                <div>
                  <label htmlFor="calvingDate" className="block mb-1">
                    Calving Date
                  </label>
                  <input
                    id="calvingDate"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleEntryChange(selectedEntry, "sex", e.target.value)
                    }
                    className="border p-2 rounded w-full"
                  >
            ...
            {entries.map((entry, index) => (
              <CardBox key={index}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                  <p>Name: {entry.firstName + " " + entry.lastName || "N/A"}</p>
