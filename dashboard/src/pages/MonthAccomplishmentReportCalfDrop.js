...
const MonthAccomplishmentReportCalfDrop = () => {
    ...
    return (
        <div className="p-6 bg-gray-100 min-h-screen">
            <h1 className="text-3xl font-bold text-center mb-8">Technician Quarterly Report</h1>
            ...
            {loading ? (
                ...
                <>
                    ...
                    <div className="bg-white p-4 mb-6 shadow-md rounded-md">
                        <p className="font-semibold text-gray-700">Total Entries: {filteredData.reduce((acc, item) => acc + item.animalEntries.length, 0)}</p>
